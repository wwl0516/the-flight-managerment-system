...
void printFlightList(const QVariantList &flightList) {
...
void printFlight(const QVariantMap &flight) {
    if (flight.isEmpty()) {
        qInfo() << "查询结果：无此航班\n";
        return;
    }
...
int main(int argc, char *argv[])
{
    ...
    if (deleteSuccess) {
        ...
        printFlightList(flightsAfterDelete);
    }
